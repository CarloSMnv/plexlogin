			...
			<div class="registro activo" id="registro">
				...
				<form class="formulario" id="formulario" action="CreateUser.php" method="POST">
					...
					<div class="contenedor-input">
						...
						<input type="text" id="nameUser" name="name" required="true">
					</div>
					...
					<div class="contenedor-input">
						...
						<input type="email" id="emailUser" name="email" required="true">
					</div>
					...
					<div>
						<div class="g-recaptcha" data-sitekey="6LfBidMlAAAAAJJaDCQ4o6hwRZo6PncTseTtttGo">	
						</div>
					</div>
